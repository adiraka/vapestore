...
<div class="container"><a href="index.html" class="navbar-brand home"><img src="{{ asset('web/img/logo.png') }}" alt="Obaju logo" class="d-none d-md-inline-block"><img src="{{ asset('web/img/logo-small.png') }}" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
        ...
        <ul class="dropdown-menu megamenu">
          <li>
            <div class="row">
              ...
              <div class="col-md-6 col-lg-3">
                <div class="banner"><a href="#"><img src="{{ asset('web/img/banner.jpg') }}" alt="" class="img img-fluid"></a></div>
                <div class="banner"><a href="#"><img src="{{ asset('web/img/banner2.jpg') }}" alt="" class="img img-fluid"></a></div>
              </div>
            </div>
          </li>
        </ul>
